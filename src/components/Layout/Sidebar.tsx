                      ...
                      className={({ isActive }) =>
                        `flex items-center justify-center w-11 h-11 mx-auto rounded-2xl transition-all duration-200 ${
                          isActive
                            ...
                            : 'text-foreground/70 hover:bg-accent hover:text-accent-foreground hover:scale-105'
                        }`
                      }
                    >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                size="icon"
                onClick={toggleTheme}
                className="w-11 h-11 rounded-2xl mx-auto hover:scale-105 transition-transform text-foreground/70 hover:text-accent-foreground"
              >
                {theme === 'light' ? (
